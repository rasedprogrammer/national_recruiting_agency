    ...
    <div className="via-root to-root rounded-xl bg-gradient-to-r p-0.5">
      <div className="rounded-[10px] p-6">
        ...
        <p className="mb-6 max-w-xl text-sm text-[#0007149f] dark:text-gray-100 font-normal">
          Sessions are the devices you are using or that have used your National
          Recruiting Agency These are the sessions where your account is
          ...
          <div className="rounded-t-xl max-w-xl">
            <div>
              ...
              <p className="mb-6 text-sm text-[#0007149f] dark:text-gray-100">
                You’re logged into this National Recruiting Agency account on
                this device and are currently using it.
              </p>
            </div>
